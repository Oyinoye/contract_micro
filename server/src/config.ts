...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8086';
  'jhipster.clientApp.name' = 'maxContract';
  ...
  'jhipster.mail.from' = 'maxContract@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'maxContract API';
  'jhipster.swagger.description' = 'maxContract API documentation';
  ...
  'eureka.instance.appname' = 'maxContract';
  'eureka.instance.instanceId' = 'maxContract:${random.value}';
