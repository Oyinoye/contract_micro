...
export class ContractDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('maxContractApp.contract.delete.question'));
...
export default class ContractComponentsPage {
  ...
  async deleteContract() {
    ...
    expect(await contractDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/maxContractApp.contract.delete.question/);
